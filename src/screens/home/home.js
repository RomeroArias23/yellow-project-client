...
function Home() {
  return (
    <div className='text'>
      ...
      <p>El proyecto <strong>{ YELLOW }</strong> se inspira en el proyecto en inglés <strong>The Unsent Project</strong>, esta aplicación tiene como objetivo recopilar mensajes de texto no enviados a primeros amores, permitiendo a quienes participen expresar de manera anónima mensajes que no pudieron enviar en su momento.</p>
